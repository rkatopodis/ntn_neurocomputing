...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        config={
            ...
            "lr": tune.grid_search([0.0003, 0.001, 0.004]),
            "observation_filter": "MeanStdFilter",
            "gamma": tune.grid_search([0.98, 0.99, 0.999]),
            "train_batch_size": tune.grid_search([4_000, 8_000, 16_000]),
            "num_sgd_iter": tune.grid_search([1, 5, 10, 20]),
